...
export default function Education() {
  return (
    <>
      <div className="bg-anderson-tower flex h-full flex-col justify-center bg-cover bg-center bg-no-repeat lg:h-screen">
        <div className="flex h-full flex-col justify-center bg-white/75 lg:h-screen">
