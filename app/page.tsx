        ...
        <div className="flex min-h-screen flex-col items-center justify-between text-center">
          ...
          <section className="relative flex flex-col items-center justify-between px-8 pb-24 pt-20 lg:gap-6">
            ...
            <p className="pb-12 font-antic text-base md:max-w-3xl md:leading-loose">
              ...
              custom web applications. Schedule a consult and we&apos;ll discuss
              how near that future may be for your latest idea or your oldest
              legacy application.
            </p>
            ...
            <div className="flex flex-col gap-12 md:max-w-3xl lg:max-w-4xl lg:flex-row">
              <div className="flex flex-col items-center justify-between gap-8 rounded-2xl bg-slate-50 p-8 px-8 shadow-sm md:flex-row md:items-start md:pl-12 md:pr-16 lg:flex-col lg:items-center lg:px-8">
                ...
                <div className="flex flex-col items-center justify-between gap-8">
                  ...
                  <p className="font-antic text-base md:w-full md:text-start lg:text-center">
                    If your existing web application is outdated or running
                    slow, refactoring your code may be the right choice for you.
                    With over seven years experience managing and refactoring
                    legacy codebases, I can expertly navigate even the messiest
                    of codebases.
                  </p>
              ...
              <div className="flex flex-col items-center justify-between gap-8 rounded-2xl bg-slate-50 p-8 px-8 shadow-sm md:flex-row md:items-start md:pl-12 md:pr-16 lg:flex-col lg:items-center lg:px-8 ">
                ...
                <div className="flex flex-col items-center justify-between gap-8">
                  ...
                  <p className="font-antic text-base md:w-full md:text-start lg:text-center">
                    So, you&apos;ve got an idea for an app? Partner with me and
                    we will turn your idea into reality. You will have total
                    creative control as your app is prototyped, developed, and
                    deployed. I stay informed with the latest development tools
                    to ensure that your app has the cutting edge designs,
              ...
              <div className="flex flex-col items-center justify-between gap-8 rounded-2xl bg-slate-50 p-8 px-8 shadow-sm md:flex-row md:items-start md:pl-12 md:pr-16 lg:flex-col lg:items-center lg:px-8">
                ...
                <div className="flex flex-col items-center justify-between gap-8">
                  ...
                  <p className="font-antic text-base md:w-full md:text-start lg:text-center">
                    ...
                    tasks by sharing data and executing pre-defined processes.
                    If you have data that you need to share with your customers
                    or other applications, creating an API may be the right
                    choice for you.
                  </p>
                  <div className="md:grid md:w-full md:justify-items-end lg:justify-items-center">
